...
import styles from '../styles/ProUpgrade.module.css';
...
const ProUpgradeButton: React.FC<ProUpgradeButtonProps> = ({
  userId,
  userEmail,
  variant = 'monthly',
  className
    ...
    try {
      ...
      const response = await fetch('/api/stripe/checkout', {
        ...
        body: JSON.stringify({
          ...
          userId,
          userEmail,
          successUrl: `${window.location.origin}/profile/blogger-pro?success=true`,
          cancelUrl: `${window.location.origin}/profile/blogger-pro?cancelled=true`,
        }),
      });
