export const blogSubmissionReceivedTemplate = {
  ...
  template: (firstName: string, blogTitle: string) => `
    ...
    <p>Your submission is now under review by our team. We'll review it within 1-2 business days and let you know the outcome.</p>
    <p>What happens next:</p>
    <ul>
      <li>Our team will review your post for quality and guidelines compliance</li>
      <li>If approved, it will be added to our blogroll</li>
