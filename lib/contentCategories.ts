...
// Utility function to get all tags as a flat array
export const getAllTags = (): string[] => {
  return Object.values(TAGS).flat();
};

// Utility function to get tags by category
export const getTagsByCategory = (category: keyof typeof TAGS): string[] => {
  return TAGS[category] || [];
};

// Popular tags for quick access (derived from themes & topics)
export const POPULAR_TAGS = [
  'Mental Health', 'Self-Care', 'Productivity', 'Personal Growth', 'Tech for Good',
  'Entrepreneurship', 'Financial Literacy', 'Relationships', 'Book Reviews',
  'Developer Life', 'Minimalist Living', 'Sustainable Living'
];
