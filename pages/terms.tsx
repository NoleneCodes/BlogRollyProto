...
const Terms: NextPage = () => {
  return (
    <Layout title="Terms and Conditions - BlogRolly">
      <div className={styles.missionSection}>
        ...
        <ol>
          ...
          <li><a href="#third-party-websites">THIRD-PARTY WEBSITES AND CONTENT</a></li>
          <li><a href="#services-management">SERVICES MANAGEMENT</a></li>
          <li><a href="#privacy-policy-ref">PRIVACY POLICY</a></li>
          <li><a href="#dmca-notice">DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</a></li>
          ...
          <li><a href="#uk-users">UK USERS AND RESIDENTS</a></li>
        ...
        <p>
          BlogRolly provides a personal blog directory service that allows users to discover, organise, and share their favourite blogs. Our Services include blog discovery tools, personalised recommendations, blog submission features, and community features for both blog readers and bloggers.
        </p>
        <p>
        ...
        <p>
          We accept the following forms of payment: Credit cards, debit cards, and other payment methods as made available through our payment processors.
        </p>
        <p>
          You may be required to purchase or pay a fee to access some of our premium Services. You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed.
        </p>

        <h2 id="subscriptions">6. SUBSCRIPTIONS</h2>
        <p>
          Some of our Services are available on a subscription basis. Subscription fees are charged in advance on a recurring basis. You may cancel your subscription at any time by logging into your account or contacting us using the contact information provided below. Your cancellation will take effect at the end of the current paid term.
        </p>

        <h2 id="prohibited-activities">7. PROHIBITED ACTIVITIES</h2>
        <p>
        ...
        <ul>
          ...
          <li>Submit spam, AI-generated content, or fraudulent blog submissions.</li>
          <li>Attempt to impersonate another blogger or misrepresent blog ownership.</li>
        </ul>
        ...
        <h2 id="privacy-policy-ref">12. PRIVACY POLICY</h2>
        <p>
          We care about data privacy and security. Please review our Privacy Policy, which can be found on our website. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms.
        </p>

        <h2 id="dmca-notice">13. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</h2>
        <p>
        ...
        <h2 id="modifications-interruptions">15. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p>
        ...
        <p>
          These Legal Terms shall be governed by and defined following the laws of England and Wales. BlogRolly Ltd and yourself irrevocably consent that the courts of England and Wales shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
        </p>
        ...
        <h2 id="limitations-liability">20. LIMITATIONS OF LIABILITY</h2>
        <p>
          IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION, LOSS OF PROFIT, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>
