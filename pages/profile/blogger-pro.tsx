...
import ProBlogCard from '../../components/ProBlogCard';
...
import styles from '../../styles/BloggerProfilePro.module.css';
...
const BloggerProfilePro: React.FC = () => {
...
export default BloggerProfilePro;
